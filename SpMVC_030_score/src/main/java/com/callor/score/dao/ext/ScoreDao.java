...
public interface ScoreDao extends GenericDao<ScoreVO, String>{
	 ...
	 * 
	 * 문자열일 경우 resultType으로 String을 반드시 지정
	 * String: String
	 * 
	 * Dao method의 return type도 wrapper class type으로 지정한다
	 */
	public Integer scoreCount(String st_num);
	public Integer scoreSum(String st_num);
	
	/*
	 * Mybatis method, maper에서 사용할 변수가 2개 이상일 경우
...
//	 #{sc_stnum}, #{sc_sbcode}, #{sc_score}
	...
	public void insertOrUpdateForList(@Param("st_num") String sc_stnum, 
