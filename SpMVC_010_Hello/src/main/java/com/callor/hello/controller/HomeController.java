...
//	}
	 ...
	 * 
	 * 이 방식은 접속자가 많이 발생할경우 메모리 leak(누수)가 발생하여
	 * 성능이 저하되는 현상이 발생할 수 있다
	 * 
	 * 이 방식으로 객체를 주입받으려면 객체이름을 클래스명의 첫글자만
	 * 소문자로 하고 그대로 사용해야 한다.
	 */
	@Autowired
	...
	public String home(Locale locale, Model model) {
		...
		System.out.println("첫번째 : "+ homeService.add(10, 20));
		System.out.println("두번째 : "+ hService.add(30, 45));
		return "home";
	}
