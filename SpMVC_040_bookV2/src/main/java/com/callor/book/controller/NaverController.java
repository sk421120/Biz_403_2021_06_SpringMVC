...
public class NaverController {
	 ...
	 * ?username=callor&pw=234567
	 * 
	 * 2. Request Body에 담아 보내는 방법
	 * <form method=POST><input username>
	 * 
	 * 3. url Path(Path Variable) 방식
	 * http://localhose:8080/book/naver/korea
	 * http://localhose:8080/book/naver/callar/234567
	 * Mapping(value="/namver/{username/{password}
	 * 
	 */
	@RequestMapping(value="/{CAT}", method=RequestMethod.GET)
	public String home(@PathVariable(name="CAT") String cat,
			@RequestParam(name="search", required = false, defaultValue = "")String search,  Model model) throws MalformedURLException, ParseException, IOException {
