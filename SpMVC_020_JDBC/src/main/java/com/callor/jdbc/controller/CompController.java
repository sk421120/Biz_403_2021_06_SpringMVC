...
public class CompController {
	...
	public String getList(@RequestParam(name="cp_title", required = false, defaultValue="") String searchText,
			Model model) {
	...
	public String update(String pk) {
